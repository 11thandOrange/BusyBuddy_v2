...
/**
 * MixAndMatchEditor - Editor for Mix and Match app
 ...
 * URL: /mix-and-match/editor/:id (edit) or /mix-and-match/editor (create)
 */
    ...
    const fetchBundle = async () => {
      try {
        ...
        if (bundle) {
          ...
          setBundleTitle(bundle.title || 'Mix & Match - Save More! 🔥');
          ...
          setSelectedTier(bundle.selectedTier || 2);
          if (bundle.tierDiscounts) {
                    ...
                    availableProducts.slice(0, 10).map(product => (
                      <div key={product.id} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px', background: 'rgba(255,255,255,0.05)', borderRadius: '8px', marginBottom: '8px', border: '1px solid rgba(255,255,255,0.1)' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                          <img src={product.media || tshirt} alt={product.title} style={{ width: '40px', height: '40px', borderRadius: '6px', objectFit: 'cover' }} onError={(e) => { e.target.onerror = null; e.target.src = tshirt; }} />
                          <div>
...
export default MixAndMatchEditor;
