...
export default function BundleDiscountActions() {
    ...
    const handlePreviewOptionChange = (productId, optionName, value) => {
        setPreviewProductsSelectedOptions((prev) => {
            ...
            updatedOptions[productId].title = Object.keys(updatedOptions[productId].options).map((key) => updatedOptions[productId].options[key]);
	...
	const getProductPrice = (productId) => {
		const product = variantPricing.find((p) => p.productId === productId && p.title === previewProductsSelectedOptions[productId]?.title);
        if (product) {
														...
														<div className="d-flex align-items-center">
															...
															<div className="bundlebox">
																...
																<div className="bundletxtb2">
																	<p>
																		{product?.optionSelections?.length} Option
																	</p>
																	<p>
																		{product?.optionSelections?.reduce(
																			(acc, option) =>
																				acc * option.values.length,
																			1
																		)}{" "}
																		Variants
																	</p>
									...
									<Card className="border-0">
										<CardBody>
											...
											<p
												...
												className="linrrow"
											>
												A ‘Percentage’ discount reduces the bundle products
												prices.
											</p>
											<div className="d-flex flex-nowrap gap-1 align-items-center justify-content-start px-2 py-2 mt-2">
												...
												>
													Customers are eligible for complimentary shipping on
													all orders placed within this bundled discount offer.
												</p>
											</div>
										</CardBody>
									</Card>
										...
										<CardBody>
											...
											>
												<div className="d-flex justify-content-between align-items-center mb-3 linewhite">
													<div className="d-flex flex-column gap-2">
														...
														>
															Get Noticed! Want to make sure your message
															doesn't get missed? Announcement Bar lets you
															display important alerts right at the top of your
															store. Whether it's a sale, promotion, or update,
											...
											>
												...
												<div className="d-flex align-items-center gap-2">
													...
													>
														Show countdown timer this will include a ((counter))
														tag in the Secondary text. can reposition the
														countdown timer anywhere in the Secondary text by
														moving the tag
													</p>
												</div>
												<div className="d-flex align-items-center justify-content-between gap-2">
										...
										<CardBody className="d-flex flex-column gap-2">
											...
											>
												...
												<div className="position-relative">
													...
													>
														<option>
															Select the bundle on the product pages
														</option>
											...
											>
												...
												<Form.Label className="inputtitle mt-3">
													Display this bundle anywhere by placing this HTML Tag
													in your theme file.
												</Form.Label>
