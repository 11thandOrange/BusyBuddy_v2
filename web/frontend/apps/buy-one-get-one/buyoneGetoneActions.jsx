...
export default function BuyoneGetoneActions({ onSearch }) {
  ...
  const handleInputChange = (e) => {
    ...
    onSearch && onSearch(e.target.value); // Optional callback
  };
              ...
              <Card className="border-0">
                <CardBody>
                  ...
                  {selectedProducts.map((product, idx) => (
                    <Card
                      className="border-0 mb-2 d-flex gap-2 flex-column p-0 m-0"
                      key={idx}
                      style={{
                        width:"100"
                      }}
                    ...
                    >
                      <div   style={{
                        ...
                        <CardBody className="d-flex align-items-center justify-content-between m-0">
