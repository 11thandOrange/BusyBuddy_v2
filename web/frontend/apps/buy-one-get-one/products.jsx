        ...
        bundleData.forEach(productComponent => {
            ...
            if (!productComponent.optionSelections || productComponent.optionSelections.length === 0) {
                ...
                combinations.forEach(combo => {
                    ...
                    const shopifyVariantNode = productDetailsNode.variants.nodes.find(v => v.title === variantTitleKey);
                    if (shopifyVariantNode) {
                        ...
                        console.warn(`Shopify variant not found for product ${productComponent.title} with combination title "${variantTitleKey}". Combo:`, combo);
                    }
                });
            }
        });
