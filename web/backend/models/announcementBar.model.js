...
const announcementBarSchema = new mongoose.Schema(
  {
    ...
    generalColorSettings: {
      type: generalColorSettingsSchema,
      default: () => ({ "Background Color": "#007bff", "Message Font Color": "#ffffff" }),
    },
    ...
    showWaveOptions: { type: Boolean, default: false },
    timerStylingSettings: { type: Object, default: {} },
    timeRemaining: {
      type: Object,
      default: {
        days: 0,
