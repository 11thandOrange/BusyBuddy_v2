...
export const sidebarSections: Record<string, NavSection> = {
  ...
  api: {
    ...
    children: [
      ...
      { title: 'Bundle Analytics', href: '/api/bundle-analytics' },
  ...
  'ci-cd': {
    ...
    children: [
      ...
      { title: 'Seed Demo Store', href: '/ci-cd/seed-demo-store' },
      { title: 'Fetch Demo Images', href: '/ci-cd/fetch-demo-images' },
      { title: 'Resolve Demo Images', href: '/ci-cd/resolve-demo-images' },
      { title: 'Inspect Demo Theme', href: '/ci-cd/inspect-demo-theme' },
      { title: 'Record Demo Videos', href: '/ci-cd/record-demos' },
    ],
  },
  architecture: {
    title: 'Architecture',
