  ...
  return (
    <div className="min-h-screen bg-background text-content">
      ...
      <main className="mx-auto max-w-container px-6 pb-20 pt-32">
        ...
        <h1 className="mt-2 text-heading-lg font-bold text-white">Built for stores that need more than one app</h1>
        ...
        <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2">
          <div>
            <h2 className="text-heading-sm font-bold text-white">One install, six apps</h2>
          ...
          <div>
            <h2 className="text-heading-sm font-bold text-white">Pay for what you use</h2>
            <p className="mt-2 prose-body">
          ...
          <div>
            <h2 className="text-heading-sm font-bold text-white">Consistent by design</h2>
            <p className="mt-2 prose-body">
          ...
          <div>
            <h2 className="text-heading-sm font-bold text-white">Built on the Shopify platform</h2>
            <p className="mt-2 prose-body">
